...
import { addTeacher } from '@/services/admin/teamsController'
...
function AddTeacher() {
    ...
    useEffect(() => {
        setTimeout(() => {
            setHtml_cn('<h1 style="text-align: center;">中文名</h1><hr/><p>老师介绍</p>')
            setHtml_en('<h1 style="text-align: center;">name EN-US</h1><hr/><p>english intro</p>')
        }, 500)
    }, [])
    ...
    const onClick = async () => {
        ...
        const resData = await addTeacher(data)
